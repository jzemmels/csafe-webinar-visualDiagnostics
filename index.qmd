...
| @baldwin, Inc. as errors| 34.76 | 1.37 | 23.62 |
...
In second row, the model selected to balance the false palse positive and false negative error rates has a larger overall error rate of 2.1%, but this consists of a false positive and false negative error rates that are much closer to each other.

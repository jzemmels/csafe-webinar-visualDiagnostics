...
```{r x3pImage,fig.align="center",fig.width=5,eval=FALSE}
...
## Visual Diagnostic Statistics {.smaller}
...
Compute features after applying the Density-Based Spatial Clustering of Applications with Noise (DBSCAN) algorithm to the cell-based image registration results [Ester et al.]
